...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_dbl_db',                      # Or path to database file if using sqlite3.
...
#STATIC_ROOT = ''.join([PATH_PJT, '/static',])
...
SECRET_KEY = '#4nylic2j+itpzo@wqhgftjhtfjhgfkhjfk765465jg^#$myv*ovk(vt#%rz=&u58m6e%dozgu71!k'
